        ...
        <nav className="container13">
          ...
          <ul className="links">
            <li className="list">
              <Link to="/">
                {" "}
                <button className="nav-btt">Home</button>
              </Link>
            ...
            <li className="list">
              <Link to="/Buyhome">
                {" "}
                <button className="nav-btt">E-Commerce</button>
              </Link>
              <div className="home_underline"></div>
            </li>
            {/* <li class="list">
      <Link  to='/Buyproducts' >  <button className='nav-btt'>Products</button></Link>
        <div class="home_underline"></div>
            ...
            <li className="list">
              <Link to="/Franchise">
                {" "}
                <button className="nav-btt">Franchise</button>
              </Link>
              <div className="home_underline"></div>
            </li>
            <li className="list">
              <Link to="/Services">
                {" "}
                <button className="nav-btt">Services</button>
              </Link>
              <div className="home_underline"></div>
            </li>
            <li className="list">
              <Link to="/AboutUsPage">
                {" "}
                <button className="nav-btt">About</button>
              </Link>
              <div className="home_underline"></div>
            </li>
            <li className="list">
              <Link to="/Whyus">
                {" "}
                <button className="nav-btt">Why Us</button>
              </Link>
              <div className="home_underline"></div>
            </li>
            <li className="list">
              <Link to="/Whatweoffer">
                {" "}
                <button className="nav-btt">What we offer</button>
              </Link>
              <div className="home_underline"></div>
            </li>
            <Link to="/login">
              <button className="btn543s">Login</button>
            </Link>
          </ul>
